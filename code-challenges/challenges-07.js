...
const objLat = (obj) => {
  ...
  let fChar1 = fName.charAt(0).toUpperCase() + fName.slice(1);

  let lName = obj.lastName;
  let fChar2 = lName.charAt(0).toUpperCase() + lName.slice(1);

  let output = `my name is ${fChar1} ${fChar2} I am ${obj.age} YO, and I love ${obj.hobby}.`;
