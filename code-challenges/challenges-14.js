...
const LastWord = (str) => {
    ...
    let lastWord = str.slice(lastSpace+1,lastIndex);
...
const replaceWords = (str) => {
    ...
    for (let idx=0;idx<strArr.length; idx++){
        ...
        if (strArr[idx] == 'I'){
            strArr.splice(idx,1,'We');
        } 
        else if (strArr[idx] =='am'){
            strArr.splice(idx,1,'are');
        }
        else if(strArr[idx] == 'was'){
            strArr.splice(idx,1,'were');
        }
    }
